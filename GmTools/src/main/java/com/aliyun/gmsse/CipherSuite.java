...
final public class CipherSuite {
    public static final String ECC_SM2_WITH_SM4_SM3="ECC-SM2-WITH-SM4-SM3";
    ...
    public static final CipherSuite GMTLS_SM2_WITH_SM4_SM3 = new CipherSuite("ECC", "SM2", "SM4", "SM3", 128, 0xe0, 0x13,
            ECC_SM2_WITH_SM4_SM3, ProtocolVersion.GMTLS_1_1);
    ...
    public static CipherSuite resolve(int id1, int id2, ProtocolVersion version) {
        if (version == ProtocolVersion.GMTLS_1_1) {
            if (id1 == 0xe0) {
                switch (id2) {
                    case 0x13:
